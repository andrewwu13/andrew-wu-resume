...
#two-col-entry(
  left-content: [
    #strong[McMaster University],  in Engineering -- Hamilton, Ontario
  ],
  right-content: [
    Sept 2025 – present
  ],
...
#two-col-entry(
  left-content: [
    #strong[St. Robert Catholic High School],  in IB Diploma 
  ],
  right-content: [
    Sept 2021 – June 2025
  ],
...
#one-col-entry(
  content: [- Canadian Youth Physicist's Tournament Gold Medal | IYPT],
)
#v(design-entries-vertical-space-between-entries)
#one-col-entry(
  content: [- Certified B1 French Speaker | Diplôme D'études En Langue Française],
)
#v(design-entries-vertical-space-between-entries)
#one-col-entry(
